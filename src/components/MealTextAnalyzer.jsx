...
export default function MealTextAnalyzer({ onAddFoods, onClose }) {
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 36, height: 36, borderRadius: 12, background: 'linear-gradient(135deg, #0891b2, #06b6d4)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              {SpeechRecognitionCtor && (
                <button
                  ...
                  style={{
                    width: 52, flexShrink: 0, borderRadius: 14, border: 'none', cursor: 'pointer',
                    background: listening ? '#dc2626' : 'var(--surface-3)', color: listening ? 'white' : 'var(--text-primary)',
                  ...
                  {result.foods.map((food, i) => {
                    ...
                    return (
                      <motion.div key={i} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.05 }}
                        ...
                        <button onClick={() => toggleFood(i)} style={{ width: 26, height: 26, borderRadius: 8, border: `2px solid ${selected.has(i) ? '#0891b2' : 'var(--border)'}`, background: selected.has(i) ? '#0891b2' : 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}>
